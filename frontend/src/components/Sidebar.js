...
import { Plus, FileJson, Search, Trash2 } from 'lucide-react';
...
import { getAllRecentDocuments, clearRecentDocuments } from '@/lib/localDB';
...
export default function Sidebar({
  ...
  }, [database, openedDocumentsVersion]);
        ...
        {recentDocuments.length > 0 ? (
          <div className="p-2">
            <div className="flex items-center justify-between px-2 py-2 mb-1">
              <div className="flex items-center gap-1">
                ...
                <span className="text-xs font-medium text-slate-500 uppercase tracking-wider">Opened Documents</span>
              </div>
              <button
          ...
          <div className="flex-1 flex items-center justify-center p-8">
            <div className="text-center">
              ...
              <p className="text-sm text-slate-400">No opened documents</p>
